...
- (void)test_get_raw {
    ...
    XCTAssertEqual(holder->value(), (std::vector<int>{0, 1, 2}));
}
...
- (void)test_erase_at {
    ...
    XCTAssertEqual(holder->value(), (std::vector<int>{0, 2}));
}
...
- (void)test_insert {
    ...
    XCTAssertEqual(holder->size(), 3);
    XCTAssertEqual(holder->value(), (std::vector<int>{0, 2, 1}));
}
...
- (void)test_replace_all {
    ...
    XCTAssertEqual(holder->size(), 3);
    XCTAssertEqual(holder->value(), (std::vector<int>{2, 3, 4}));
}
...
- (void)test_replace {
    ...
    XCTAssertEqual(holder->size(), 3);
    XCTAssertEqual(holder->value(), (std::vector<int>{0, 10, 2}));
}
